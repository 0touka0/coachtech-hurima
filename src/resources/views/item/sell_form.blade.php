            ...
            <div class="sell-form">
                ...
                <div class="sell-item-image">
                    ...
                    <div class="sell-item-image__form">
                        <img class="sell-item-image__image" src="" alt="商品画像">
                        <button class="sell-item-image__btn" type="button">画像を選択する</button>
                        <input class="sell-item-image__input" type="file" name="image" accept="image/*">
                    </div>
                    @if ($errors->has('image'))
                ...
                <!-- 出品ボタン -->
                <button class="btn sell-form__btn" type="submit">出品する</button>
            </div>
        </form>
    </div>
@endsection
